...
describe("School List", () => {
  it("displays article for each school in passed list", () => {
    render(<SchoolList schools={testSchools} />);
    const cardCount = screen.getAllByRole("article").length;

    expect(cardCount).toBe(testSchools.length);
  });
  ...
  describe.todo("filter", () => {
    ...
    it("filters by phone", () => {});
    it("filters by bus area", () => {});
    it("filters by nearby station", () => {});
  });
});
...
const testSchools: school[] = [
  ...
  },
  {
    id: 7,
    name: "りんかい東雲",
    address: "〒135-0062 東京都江東区東雲２丁目１−２２ キャッスルビル東雲 4階",
    phone: "0120-378-056",
    busAreas: ["江東区", "港区"],
