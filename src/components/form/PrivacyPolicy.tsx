...
/* static text: updatewhenever the wording is changed        */

const POLICY_JA = `プライバシーポリシー
...
個人情報を共同利用する場合、株式会社P-UP Worldがその責任において管理します。株式会社P-UP Worldの住所および代表者氏名については、こちらをご覧ください。
...
export default function PrivacyPolicy({
  ...
  useEffect(() => {
    displayModal ? modalRef.current?.showModal() : modalRef.current?.close();
  }, [displayModal]);
    ...
    <div className="flex flex-col gap-2">
      ...
      >
        <div className="modal flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto whitespace-pre-wrap leading-relaxed text-sm md:text-base">
            {POLICY_JA}
          </div>
