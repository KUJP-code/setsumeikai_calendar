				...
				return (
					...
					>
						<input
							...
							id={o.name}
							value={o.value}
							className="relative appearance-none rounded-full border-2 border-ku-faded w-[14px] h-[14px] checked:border-ku-orange checked:before:bg-ku-orange checked:before:w-[8px] checked:before:h-[8px] checked:before:rounded-full flex items-center justify-center"
						/>
						<label htmlFor={o.name} className="text-ku-secondary">
							{o.name}
						</label>
					</div>
				);
